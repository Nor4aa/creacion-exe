...
from PySide6.QtGui import QAction, QIcon, QKeySequence, QTextCursor, QTextDocument, QColor, QTextCharFormat
from PySide6.QtWidgets import (
    QApplication, QMainWindow, QToolBar, QTextEdit, QFileDialog,
    QMessageBox, QWidget, QLineEdit, QPushButton, QLabel, QVBoxLayout,
    QHBoxLayout, QColorDialog, QFontDialog, QStatusBar, QGroupBox, QRadioButton
)
from PySide6.QtMultimedia import QMediaPlayer, QAudioOutput


# ======== FUNCION PARA PYINSTALLER =========
...
class VentanaPrincipal(QMainWindow):
    def __init__(self):
        ...
        self.hilo_voz = threading.Thread(target=self.escuchar_voz, daemon=True)
        self.hilo_voz.start()
        ...
        ruta_audio = ruta_recurso("resources/sonido.mp3")
        ...
        layout.addWidget(self.panel_busqueda)
        ...
        self.status_bar.addPermanentWidget(self.contador)
    ...
    def crear_panel(self):
        panel = QGroupBox("Buscar / Reemplazar")
        layout = QVBoxLayout()

        self.buscar_input = QLineEdit()
        self.reemplazar_input = QLineEdit()
        self.radio_todos = QRadioButton("Todas")

        boton = QPushButton("Buscar")
        boton.clicked.connect(self.buscar_texto)
